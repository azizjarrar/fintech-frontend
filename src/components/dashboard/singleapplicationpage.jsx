  ...
  return (
    <div className="w-full  h-full p-4 overflow-y-scroll ">
      ...
      {singleApplication?.status !== "rejected" &&
        ...
        singleApplication?.status !== "buyer_disapproved" &&
            ...
            <ul className="w-full flex items-center justify-around p-4 relative ">
              <li className="flex items-center justify-around ">
                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border text-center rounded-full ${step === 1
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 2 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 2
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 2
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 3 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 3
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 3
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 4 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 4
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 4
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 5 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 5
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 5
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 6 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 6
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 6
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
              ...
              <li className="w-1/5 flex items-center">
                <div
                  className={`w-[80%] h-0.5 ${step >= 7 ? "bg-primary-default" : "bg-background-light"
                    }`}
                ></div>

                <div className="w-[20%] flex items-center justify-around flex-col">
                  <div
                    className={`w-8 h-8 z-10 bg-background-light flex items-center justify-between border border rounded-full ${step === 7
                        ? "border !bg-primary-default text-white rounded-full flex items-center justify-around"
                        : step > 7
                          ? "border !bg-primary-light text-primary-dark flex items-center justify-around"
                          : "border border-black flex items-center justify-around"
